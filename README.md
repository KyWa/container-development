...
Although there are plenty of examples we will be focusing on Python that are built upon UBI. For reference we will be focusing on this [Python 3.8](https://catalog.redhat.com/software/containers/rhel8/python-38/5dde9cb15a13461646f7e6a2) image for our testing. At the bottom of this post you will find [links](#links) which point to the various files that these images use.
